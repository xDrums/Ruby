...
class ArticulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post articulos_url, params: { articulo: { count_vts: @articulo.count_vts, cuerpo: @articulo.cuerpo, image: @articulo.image, link_mercado: @articulo.link_mercado, titulo: @articulo.titulo } }
    end
  ...
  test "should update articulo" do
    patch articulo_url(@articulo), params: { articulo: { count_vts: @articulo.count_vts, cuerpo: @articulo.cuerpo, image: @articulo.image, link_mercado: @articulo.link_mercado, titulo: @articulo.titulo } }
